...
/// Generated from `BlockView`.
class BlockView {
  const BlockView({this.author, this.chunks, this.header});

  factory BlockView.fromJson(Map<String, dynamic> json) => BlockView(
...
/// Union type generated from `ErrorWrapper_for_RpcIndexerBlockError`.
///
/// Holds the raw decoded JSON; inspect [json] for the
/// active variant (NEAR serializes these tagged).
class ErrorWrapper_for_RpcIndexerBlockError {
  const ErrorWrapper_for_RpcIndexerBlockError(this.json);
  factory ErrorWrapper_for_RpcIndexerBlockError.fromJson(dynamic json) =>
      ErrorWrapper_for_RpcIndexerBlockError(json);
  final dynamic json;
  dynamic toJson() => json;
}
...
/// Generated from `IndexerChunkView`.
class IndexerChunkView {
  const IndexerChunkView({
    this.author,
    this.header,
    this.instant_receipts,
    this.local_receipts,
    this.receipts,
    this.transactions,
  });

  factory IndexerChunkView.fromJson(Map<String, dynamic> json) =>
      IndexerChunkView(
        author: json[r'author'] == null ? null : json[r'author'] as AccountId,
        header: json[r'header'] == null
            ? null
            : ChunkHeaderView.fromJson(json[r'header']),
        instant_receipts: json[r'instant_receipts'] == null
            ? null
            : (json[r'instant_receipts'] as List)
                  .map<ReceiptView>((e) => ReceiptView.fromJson(e))
                  .toList(),
        local_receipts: json[r'local_receipts'] == null
            ? null
            : (json[r'local_receipts'] as List)
                  .map<ReceiptView>((e) => ReceiptView.fromJson(e))
                  .toList(),
        receipts: json[r'receipts'] == null
            ? null
        ...
        transactions: json[r'transactions'] == null
            ...
            : (json[r'transactions'] as List)
                  .map<IndexerTransactionWithOutcome>(
                    (e) => IndexerTransactionWithOutcome.fromJson(e),
                  )
                  .toList(),
      );
  ...
  final List<ReceiptView>? instant_receipts;
  final List<ReceiptView>? local_receipts;
  final List<ReceiptView>? receipts;
  final List<IndexerTransactionWithOutcome>? transactions;

  Map<String, dynamic> toJson() => {
    if (author != null) r'author': author,
    if (header != null) r'header': header?.toJson(),
    if (instant_receipts != null)
      r'instant_receipts': instant_receipts?.map((e) => e.toJson()).toList(),
    if (local_receipts != null)
      r'local_receipts': local_receipts?.map((e) => e.toJson()).toList(),
    if (receipts != null)
      r'receipts': receipts?.map((e) => e.toJson()).toList(),
...
/// Generated from `IndexerExecutionOutcomeWithOptionalReceipt`.
class IndexerExecutionOutcomeWithOptionalReceipt {
  const IndexerExecutionOutcomeWithOptionalReceipt({
    this.execution_outcome,
    this.receipt,
  });

  factory IndexerExecutionOutcomeWithOptionalReceipt.fromJson(
    Map<String, dynamic> json,
  ) => IndexerExecutionOutcomeWithOptionalReceipt(
    execution_outcome: json[r'execution_outcome'] == null
        ? null
        : ExecutionOutcomeWithIdView.fromJson(json[r'execution_outcome']),
    receipt: json[r'receipt'] == null ? null : json[r'receipt'],
  );

  final ExecutionOutcomeWithIdView? execution_outcome;
  final dynamic? receipt;

  Map<String, dynamic> toJson() => {
    if (execution_outcome != null)
      r'execution_outcome': execution_outcome?.toJson(),
    if (receipt != null) r'receipt': receipt,
  };
}

/// Generated from `IndexerExecutionOutcomeWithReceipt`.
class IndexerExecutionOutcomeWithReceipt {
  const IndexerExecutionOutcomeWithReceipt({
    this.execution_outcome,
    this.receipt,
  });

  factory IndexerExecutionOutcomeWithReceipt.fromJson(
    Map<String, dynamic> json,
    ...
    receipt: json[r'receipt'] == null
        ? null
        : ReceiptView.fromJson(json[r'receipt']),
  );
...
/// Generated from `IndexerShard`.
class IndexerShard {
  const IndexerShard({
    this.chunk,
    this.receipt_execution_outcomes,
    this.shard_id,
    this.state_changes,
  });

  factory IndexerShard.fromJson(Map<String, dynamic> json) => IndexerShard(
    chunk: json[r'chunk'] == null ? null : json[r'chunk'],
    receipt_execution_outcomes: json[r'receipt_execution_outcomes'] == null
        ? null
        : (json[r'receipt_execution_outcomes'] as List)
              .map<IndexerExecutionOutcomeWithReceipt>(
                (e) => IndexerExecutionOutcomeWithReceipt.fromJson(e),
              )
              .toList(),
    shard_id: json[r'shard_id'] == null ? null : json[r'shard_id'] as ShardId,
    state_changes: json[r'state_changes'] == null
        ? null
        : (json[r'state_changes'] as List)
  ...
  final dynamic? chunk;
  final List<IndexerExecutionOutcomeWithReceipt>? receipt_execution_outcomes;
  final ShardId? shard_id;
  final List<StateChangeWithCauseView>? state_changes;

  Map<String, dynamic> toJson() => {
    if (chunk != null) r'chunk': chunk,
    if (receipt_execution_outcomes != null)
      r'receipt_execution_outcomes': receipt_execution_outcomes
          ?.map((e) => e.toJson())
          .toList(),
    if (shard_id != null) r'shard_id': shard_id,
    if (state_changes != null)
      r'state_changes': state_changes?.map((e) => e.toJson()).toList(),
  };
}

/// Generated from `IndexerTransactionWithOutcome`.
class IndexerTransactionWithOutcome {
  const IndexerTransactionWithOutcome({this.outcome, this.transaction});

  factory IndexerTransactionWithOutcome.fromJson(Map<String, dynamic> json) =>
      IndexerTransactionWithOutcome(
        outcome: json[r'outcome'] == null
            ? null
            : IndexerExecutionOutcomeWithOptionalReceipt.fromJson(
                json[r'outcome'],
              ),
        transaction: json[r'transaction'] == null
            ? null
  ...
  final IndexerExecutionOutcomeWithOptionalReceipt? outcome;
  final SignedTransactionView? transaction;
...
/// Generated from `JsonRpcRequest_for_EXPERIMENTAL_indexer_block`.
class JsonRpcRequest_for_EXPERIMENTAL_indexer_block {
  const JsonRpcRequest_for_EXPERIMENTAL_indexer_block({
    this.id,
    this.jsonrpc,
    this.method,
    this.params,
  ...
  factory JsonRpcRequest_for_EXPERIMENTAL_indexer_block.fromJson(
    Map<String, dynamic> json,
  ) => JsonRpcRequest_for_EXPERIMENTAL_indexer_block(
    id: json[r'id'] == null ? null : json[r'id'] as String,
    jsonrpc: json[r'jsonrpc'] == null ? null : json[r'jsonrpc'] as String,
    method: json[r'method'] == null ? null : json[r'method'] as String,
    params: json[r'params'] == null
        ? null
        : RpcIndexerBlockRequest.fromJson(json[r'params']),
  );

  final String? id;
  final String? jsonrpc;
  final String? method;
  final RpcIndexerBlockRequest? params;
...
/// Union type generated from `JsonRpcResponse_for_RpcIndexerBlockResponse_and_RpcIndexerBlockError`.
///
/// Holds the raw decoded JSON; inspect [json] for the
/// active variant (NEAR serializes these tagged).
class JsonRpcResponse_for_RpcIndexerBlockResponse_and_RpcIndexerBlockError {
  const JsonRpcResponse_for_RpcIndexerBlockResponse_and_RpcIndexerBlockError(
    this.json,
  );
  factory JsonRpcResponse_for_RpcIndexerBlockResponse_and_RpcIndexerBlockError.fromJson(
    dynamic json,
  ) => JsonRpcResponse_for_RpcIndexerBlockResponse_and_RpcIndexerBlockError(
    json,
  );
  final dynamic json;
  dynamic toJson() => json;
...
class LimitConfig {
  const LimitConfig({
    ...
    this.max_universal_state_init_keys,
  ...
  factory LimitConfig.fromJson(Map<String, dynamic> json) => LimitConfig(
    ...
    max_state_init_entries: json[r'max_state_init_entries'] == null
        ? null
        : (json[r'max_state_init_entries'] as num).toInt(),
    ...
    max_universal_state_init_keys:
        json[r'max_universal_state_init_keys'] == null
        ? null
        : (json[r'max_universal_state_init_keys'] as num).toInt(),
  ...
  final int? max_state_init_entries;
  ...
  final int? max_universal_state_init_keys;
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (max_state_init_entries != null)
      r'max_state_init_entries': max_state_init_entries,
    ...
    if (max_universal_state_init_keys != null)
      r'max_universal_state_init_keys': max_universal_state_init_keys,
...
/// Union type generated from `RpcIndexerBlockError`.
///
/// Holds the raw decoded JSON; inspect [json] for the
/// active variant (NEAR serializes these tagged).
class RpcIndexerBlockError {
  const RpcIndexerBlockError(this.json);
  factory RpcIndexerBlockError.fromJson(dynamic json) =>
      RpcIndexerBlockError(json);
  final dynamic json;
  dynamic toJson() => json;
}

/// Generated from `RpcIndexerBlockRequest`.
class RpcIndexerBlockRequest {
  const RpcIndexerBlockRequest({this.block_hash});

  factory RpcIndexerBlockRequest.fromJson(Map<String, dynamic> json) =>
...
/// Generated from `RpcIndexerBlockResponse`.
class RpcIndexerBlockResponse {
  const RpcIndexerBlockResponse({this.block, this.shards, this.tracked_shards});

  factory RpcIndexerBlockResponse.fromJson(Map<String, dynamic> json) =>
      RpcIndexerBlockResponse(
        block: json[r'block'] == null
            ? null
            : BlockView.fromJson(json[r'block']),
        shards: json[r'shards'] == null
            ? null
            : (json[r'shards'] as List)
                  .map<IndexerShard>((e) => IndexerShard.fromJson(e))
                  .toList(),
        tracked_shards: json[r'tracked_shards'] == null
            ? null
            : (json[r'tracked_shards'] as List)
  ...
  final List<IndexerShard>? shards;
  final List<ShardId>? tracked_shards;

  Map<String, dynamic> toJson() => {
    if (block != null) r'block': block?.toJson(),
    if (shards != null) r'shards': shards?.map((e) => e.toJson()).toList(),
    if (tracked_shards != null) r'tracked_shards': tracked_shards,
  };
}
