...
class NearJsonRpcClient {
  ...
  static const specVersion = '1.3.26';
  ...
  /// Calls the `EXPERIMENTAL_indexer_block` JSON-RPC method.
  Future<RpcIndexerBlockResponse> EXPERIMENTALIndexerBlock(
    RpcIndexerBlockRequest params,
  ) async {
    final result = await _call(r'EXPERIMENTAL_indexer_block', params.toJson());
    return RpcIndexerBlockResponse.fromJson(result);
  }
